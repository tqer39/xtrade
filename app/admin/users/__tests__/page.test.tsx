  ...
  describe('管理者ユーザー', () => {
    ...
    it('ホワイトリスト一覧を表示', async () => {
      const mockAllowedUsers = [
        { id: '1', twitterUsername: 'user1', addedBy: 'admin-1', createdAt: '2024-01-01T00:00:00Z' },
        { id: '2', twitterUsername: 'user2', addedBy: 'admin-1', createdAt: '2024-01-02T00:00:00Z' },
      ]
    ...
    it('ユーザー追加が成功する', async () => {
      ;(global.fetch as ReturnType<typeof vi.fn>)
        ...
        .mockResolvedValueOnce({
          ...
          json: () =>
            Promise.resolve({
              allowedUsers: [{ id: '1', twitterUsername: 'newuser', addedBy: 'admin-1', createdAt: '2024-01-01' }],
            }),
        })
