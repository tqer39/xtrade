...
- 技術用語（例: Terraform、Next.js、Drizzle ORM 等）
- コードブロック内のコード
- URL
- ファイルパス
- コマンド名
...
プロジェクト内の他のドキュメントを参考に、一貫性のある翻訳をしてください。

## 実行例

### ケース 1: 新しい英語ドキュメントの作成

**入力**: 新しく `docs/deployment.md` を作成する。
...
**入力**: `README.md` のセクション「Quick Start」を更新する。
...
**解決策**: プロジェクト内の既存ドキュメントを検索して、同じ用語がどう扱われているか確認する。
...
**解決策**: ユーザーに確認を求め、全体を書き換えるか部分的に更新するか判断する。
